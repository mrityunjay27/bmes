...
# session param in the function calls are from Flask Browser Session.
...
def get_cart(session):
    """
    For the given session, return its corresponding cart instance.
    :param session:
    :return:
    """
